...
import { StyleSheet, Modal, View, Text, KeyboardAvoidingView, TouchableOpacity, TextInput, Image } from 'react-native'
                ...
                <View style={styles.container}>
                    <View style={styles.modalView}>
                        ...
                        <View style={styles.idContainer}>
                            ...
                            <TextInput style={styles.idTextInput} onChange={setId}/>
                        </View>
                        <View style={styles.passwordContainer}>
                            <Text style={styles.idText} >비밀번호</Text>
                            <TextInput style={styles.idTextInput} secureTextEntry={true} onChange={setPassword}/>
                        </View>
                        ...
                        <TouchableOpacity style={styles.registerBtn} onPress={() => navigation.navigate('Certification')}>
